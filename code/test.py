...
snapshot_path = FLAGS.root_path + "model/{}_{}_{}_{}_labeled/{}".format(
    FLAGS.dataset_name, FLAGS.exp, FLAGS.dim, FLAGS.labelnum, FLAGS.model
)
test_save_path = FLAGS.root_path + "model/{}_{}_{}_{}_labeled/{}_predictions/".format(
    FLAGS.dataset_name, FLAGS.exp, FLAGS.dim, FLAGS.labelnum, FLAGS.model
)
...
if FLAGS.dataset_name == "LA":
    ...
    with open(FLAGS.root_path + "/test.list", "r") as f:
        image_list = f.readlines()
    image_list = [
        FLAGS.root_path + "/Pancreas_h5/" + item.replace("\n", "") + "_norm.h5"
        for item in image_list
    ]
