...
snapshot_path = FLAGS.root_path + "model/{}_{}_{}_{}_labeled/{}".format(FLAGS.dataset_name, FLAGS.exp, FLAGS.dim, FLAGS.labelnum, FLAGS.model)
test_save_path = FLAGS.root_path + "model/{}_{}_{}_{}_labeled/{}_predictions/".format(FLAGS.dataset_name, FLAGS.exp, FLAGS.dim, FLAGS.labelnum, FLAGS.model)
...
def test_calculate_metric():
    net = net_factory(net_type=FLAGS.model, in_chns=1, class_num=num_classes, mode="test", dim=FLAGS.dim, dataset=FLAGS.dataset_name)
    # save_mode_path = os.path.join(snapshot_path, 'iter_800_dice_0.7134973794325022.pth')
    ...
    if FLAGS.dataset_name == "LA":
        ...
        avg_metric = test_all_case(FLAGS.model, 1, net, image_list, num_classes=num_classes,
                        ...
                        save_result=True, test_save_path=test_save_path,
                        metric_detail=FLAGS.detail, nms=FLAGS.nms, dataset=FLAGS.dataset_name)
